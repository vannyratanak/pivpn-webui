...
def prune_old_logs(days: int):
    ...
    (The dedicated daily prune_db.sh/systemd timer also covers this at a
    30-day window — this per-run call and that one are redundant by
    design, not a conflict: whichever runs first wins, harmlessly.)"""
    conn = get_conn()
    try:
